...
class Lidar():
    ...
    def get_all_distances_with_subparts(self):
        """
        Get all 9 distances and their corresponding subparts.
        """
        distances = [
            self.subsets.front,
            self.subsets.l1, self.subsets.l2, self.subsets.l3, self.subsets.l4,
            self.subsets.r1, self.subsets.r2, self.subsets.r3, self.subsets.r4
        ]
        subparts = [
            "front",
            "l1", "l2", "l3", "l4",
